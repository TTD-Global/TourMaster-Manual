...
> ไฟล์ทำงาน (TASKS.md, prompts.md, img-inventory.md, SKILL.md, context.md) อยู่ใน folder นี้ (`Manual TS/`)
...
│   ├── User/
│   └── Transfer/
├── Manual TS/        ← ไฟล์ระบบสำหรับสั่งงาน Claude
│   ├── CLAUDE.md
│   ├── TASKS.md
│   ├── prompts.md
│   ├── img-inventory.md
...
- ดู img-inventory.md เพื่อรู้ว่ารูปไหนมีอยู่แล้ว
